...
public class CMDemerald implements CommandExecutor {
    ...
    public CMDemerald(BedWars plugin){
        this.plugin = plugin;
    }
            ...
            if (sender instanceof Player p) {
                ...
                if (p.hasPermission("bw.setlobby")) {
                    try {
                        ...
                        String msg1 = ChatColor.translateAlternateColorCodes('&', Objects.requireNonNull(cfg1.getString("SetEmerald")).replace("%int%", Integer.toString(i)));
